...
struct CommonPort {
    ...
    static let all: [CommonPort] = [
        CommonPort(number: 21,   service: "FTP",           isRisky: true,  riskReason: L10n.Port.ftp),
        CommonPort(number: 22,   service: "SSH",           isRisky: false, riskReason: ""),
        CommonPort(number: 23,   service: "Telnet",        isRisky: true,  riskReason: L10n.Port.telnet),
        CommonPort(number: 25,   service: "SMTP",          isRisky: false, riskReason: ""),
        CommonPort(number: 53,   service: "DNS",           isRisky: false, riskReason: ""),
        CommonPort(number: 80,   service: "HTTP",          isRisky: true,  riskReason: L10n.Port.http),
        CommonPort(number: 110,  service: "POP3",          isRisky: true,  riskReason: L10n.Port.pop3),
        CommonPort(number: 135,  service: "MS-RPC",        isRisky: true,  riskReason: L10n.Port.msrpc),
        CommonPort(number: 139,  service: "NetBIOS",       isRisky: true,  riskReason: L10n.Port.netbios),
        CommonPort(number: 143,  service: "IMAP",          isRisky: false, riskReason: ""),
        CommonPort(number: 161,  service: "SNMP",          isRisky: true,  riskReason: L10n.Port.snmp),
        CommonPort(number: 443,  service: "HTTPS",         isRisky: false, riskReason: ""),
        CommonPort(number: 445,  service: "SMB",           isRisky: true,  riskReason: L10n.Port.smb),
        CommonPort(number: 548,  service: "AFP",           isRisky: false, riskReason: ""),
        CommonPort(number: 554,  service: "RTSP",          isRisky: true,  riskReason: L10n.Port.rtsp),
        ...
        CommonPort(number: 1433, service: "MSSQL",         isRisky: true,  riskReason: L10n.Port.dbExposed),
        CommonPort(number: 1723, service: "PPTP VPN",      isRisky: true,  riskReason: L10n.Port.pptp),
        CommonPort(number: 2049, service: "NFS",           isRisky: true,  riskReason: L10n.Port.nfs),
        CommonPort(number: 3306, service: "MySQL",         isRisky: true,  riskReason: L10n.Port.dbExposed),
        CommonPort(number: 3389, service: "RDP",           isRisky: true,  riskReason: L10n.Port.rdp),
        CommonPort(number: 5000, service: "UPnP/Dev",      isRisky: true,  riskReason: L10n.Port.upnp),
        CommonPort(number: 5900, service: "VNC",           isRisky: true,  riskReason: L10n.Port.vnc),
        CommonPort(number: 5985, service: "WinRM HTTP",    isRisky: true,  riskReason: L10n.Port.winrm),
        CommonPort(number: 6881, service: "BitTorrent",    isRisky: false, riskReason: ""),
        CommonPort(number: 8080, service: "HTTP Alt",      isRisky: true,  riskReason: L10n.Port.httpAlt),
        CommonPort(number: 8443, service: "HTTPS Alt",     isRisky: false, riskReason: ""),
        CommonPort(number: 8888, service: "HTTP Proxy",    isRisky: true,  riskReason: L10n.Port.httpProxy),
        CommonPort(number: 9100, service: "JetDirect",     isRisky: false, riskReason: ""),
        CommonPort(number: 9200, service: "Elasticsearch", isRisky: true,  riskReason: L10n.Port.dbExposedNoAuth),
        CommonPort(number: 27017, service: "MongoDB",      isRisky: true,  riskReason: L10n.Port.dbExposedNoAuth),
    ]
}
